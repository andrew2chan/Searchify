...
*/
const fetchArtistByName = (artistName, accessToken) => {
    return fetch(`https://api.spotify.com/v1/search?q=${artistName}&type=artist&limit=1&offset=0`, {
            'method': 'GET',
            'headers': {
...
*/
const fetchRelatedArtistById = (artistId, accessToken) => {
